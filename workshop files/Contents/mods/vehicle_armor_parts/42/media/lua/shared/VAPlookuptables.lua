...
local modelInjectionLookup =
{
    ["CarNormal"] =
    {
        ["Armour_Bullbar"] =
        {
            {"Wood_Bullbar",  "CarNormal_Bone_Bullbar", 0.0, -0.082, 1.299, 1},
            {"Bone_Bullbar",  "CarNormal_Bone_Bullbar", 0.0, -0.082, 1.299, 1},
            {"Scrap_Bullbar", "CarNormal_Bone_Bullbar", 0.0, -0.082, 1.299, 1},
            {"Light_Bullbar", "CarNormal_Bone_Bullbar", 0.0, -0.082, 1.299, 1},
            {"Heavy_Bullbar", "CarNormal_Bone_Bullbar", 0.0, -0.082, 1.299, 1},
        },

        ["Armour_Hood"] =
        {
            {"Wood_HoodArmour",  "CarNormal_Bone_HoodArmour", 0.0, 0.066, 0.819, 1},
            {"Bone_HoodArmour",  "CarNormal_Bone_HoodArmour", 0.0, 0.066, 0.819, 1},
            {"Scrap_HoodArmour", "CarNormal_Bone_HoodArmour", 0.0, 0.066, 0.819, 1},
            {"Light_HoodArmour", "CarNormal_Bone_HoodArmour", 0.0, 0.066, 0.819, 1},
            {"Heavy_HoodArmour", "CarNormal_Bone_HoodArmour", 0.0, 0.066, 0.819, 1},
        },

        ["Armour_Windshield"] =
        {
            {"Wood_WindshieldArmour",  "CarNormal_Bone_WindshieldArmour", 0.0, 0.192, 0.341, 1},
            {"Bone_WindshieldArmour",  "CarNormal_Bone_WindshieldArmour", 0.0, 0.192, 0.341, 1},
            {"Scrap_WindshieldArmour", "CarNormal_Bone_WindshieldArmour", 0.0, 0.192, 0.341, 1},
            {"Light_WindshieldArmour", "CarNormal_Bone_WindshieldArmour", 0.0, 0.192, 0.341, 1},
            {"Heavy_WindshieldArmour", "CarNormal_Bone_WindshieldArmour", 0.0, 0.192, 0.341, 1},
        },

        ["Armour_Trunk"] =
        {
            {"Wood_TrunkArmour",  "CarNormal_Bone_TrunkArmour", 0.0, -0.059, -1.148, 1},
            {"Bone_TrunkArmour",  "CarNormal_Bone_TrunkArmour", 0.0, -0.059, -1.148, 1},
            {"Scrap_TrunkArmour", "CarNormal_Bone_TrunkArmour", 0.0, -0.059, -1.148, 1},
            {"Light_TrunkArmour", "CarNormal_Bone_TrunkArmour", 0.0, -0.059, -1.148, 1},
            {"Heavy_TrunkArmour", "CarNormal_Bone_TrunkArmour", 0.0, -0.059, -1.148, 1},
        },

        ["Armour_WindshieldRear"] =
        {
            {"Wood_WindshieldRearArmour",  "CarNormal_Bone_WindshieldRearArmour", 0.0, 0.214, -0.632, 1},
            {"Bone_WindshieldRearArmour",  "CarNormal_Bone_WindshieldRearArmour", 0.0, 0.214, -0.632, 1},
            {"Scrap_WindshieldRearArmour", "CarNormal_Bone_WindshieldRearArmour", 0.0, 0.214, -0.632, 1},
            {"Light_WindshieldRearArmour", "CarNormal_Bone_WindshieldRearArmour", 0.0, 0.214, -0.632, 1},
            {"Heavy_WindshieldRearArmour", "CarNormal_Bone_WindshieldRearArmour", 0.0, 0.214, -0.632, 1},
        },

        ["Armour_DoorFrontLeft"] =
        {
            {"Wood_DoorFrontLeftArmour",  "CarNormal_Bone_DoorFrontLeftArmour", 0.445, -0.066, 0.132, 1},
            {"Bone_DoorFrontLeftArmour",  "CarNormal_Bone_DoorFrontLeftArmour", 0.445, -0.066, 0.132, 1},
            {"Scrap_DoorFrontLeftArmour", "CarNormal_Bone_DoorFrontLeftArmour", 0.445, -0.066, 0.132, 1},
            {"Light_DoorFrontLeftArmour", "CarNormal_Bone_DoorFrontLeftArmour", 0.445, -0.066, 0.132, 1},
            {"Heavy_DoorFrontLeftArmour", "CarNormal_Bone_DoorFrontLeftArmour", 0.445, -0.066, 0.132, 1},
        },

        ["Armour_DoorFrontRight"] =
        {
            {"Wood_DoorFrontRightArmour",  "CarNormal_Bone_DoorFrontRightArmour", -0.445, -0.066, 0.132, 1},
            {"Bone_DoorFrontRightArmour",  "CarNormal_Bone_DoorFrontRightArmour", -0.445, -0.066, 0.132, 1},
            {"Scrap_DoorFrontRightArmour", "CarNormal_Bone_DoorFrontRightArmour", -0.445, -0.066, 0.132, 1},
            {"Light_DoorFrontRightArmour", "CarNormal_Bone_DoorFrontRightArmour", -0.445, -0.066, 0.132, 1},
            {"Heavy_DoorFrontRightArmour", "CarNormal_Bone_DoorFrontRightArmour", -0.445, -0.066, 0.132, 1},
        },

        ["Armour_WindowFrontLeft"] =
        {
            {"Wood_WindowFrontLeftArmour",  "CarNormal_Bone_WindowFrontLeftArmour", 0.357, 0.181, 0.115, 1},
            {"Bone_WindowFrontLeftArmour",  "CarNormal_Bone_WindowFrontLeftArmour", 0.357, 0.181, 0.115, 1},
            {"Scrap_WindowFrontLeftArmour", "CarNormal_Bone_WindowFrontLeftArmour", 0.357, 0.181, 0.115, 1},
            {"Light_WindowFrontLeftArmour", "CarNormal_Bone_WindowFrontLeftArmour", 0.357, 0.181, 0.115, 1},
            {"Heavy_WindowFrontLeftArmour", "CarNormal_Bone_WindowFrontLeftArmour", 0.357, 0.181, 0.115, 1},
        },

        ["Armour_WindowFrontRight"] =
        {
            {"Wood_WindowFrontRightArmour",  "CarNormal_Bone_WindowFrontRightArmour", -0.357, 0.181, 0.115, 1},
            {"Bone_WindowFrontRightArmour",  "CarNormal_Bone_WindowFrontRightArmour", -0.357, 0.181, 0.115, 1},
            {"Scrap_WindowFrontRightArmour", "CarNormal_Bone_WindowFrontRightArmour", -0.357, 0.181, 0.115, 1},
            {"Light_WindowFrontRightArmour", "CarNormal_Bone_WindowFrontRightArmour", -0.357, 0.181, 0.115, 1},
            {"Heavy_WindowFrontRightArmour", "CarNormal_Bone_WindowFrontRightArmour", -0.357, 0.181, 0.115, 1},
        },

        ["Armour_DoorRearLeft"] =
        {
            {"Wood_DoorRearLeftArmour",  "CarNormal_Bone_DoorRearLeftArmour", 0.445, -0.066, -0.286, 1},
            {"Bone_DoorRearLeftArmour",  "CarNormal_Bone_DoorRearLeftArmour", 0.445, -0.066, -0.286, 1},
            {"Scrap_DoorRearLeftArmour", "CarNormal_Bone_DoorRearLeftArmour", 0.445, -0.066, -0.286, 1},
            {"Light_DoorRearLeftArmour", "CarNormal_Bone_DoorRearLeftArmour", 0.445, -0.066, -0.286, 1},
            {"Heavy_DoorRearLeftArmour", "CarNormal_Bone_DoorRearLeftArmour", 0.445, -0.066, -0.286, 1},
        },

        ["Armour_DoorRearRight"] =
        {
            {"Wood_DoorRearRightArmour",  "CarNormal_Bone_DoorRearRightArmour", -0.445, -0.066, -0.286, 1},
            {"Bone_DoorRearRightArmour",  "CarNormal_Bone_DoorRearRightArmour", -0.445, -0.066, -0.286, 1},
            {"Scrap_DoorRearRightArmour", "CarNormal_Bone_DoorRearRightArmour", -0.445, -0.066, -0.286, 1},
            {"Light_DoorRearRightArmour", "CarNormal_Bone_DoorRearRightArmour", -0.445, -0.066, -0.286, 1},
            {"Heavy_DoorRearRightArmour", "CarNormal_Bone_DoorRearRightArmour", -0.445, -0.066, -0.286, 1},
        },

        ["Armour_WindowRearLeft"] =
        {
            {"Wood_WindowRearLeftArmour",  "CarNormal_Bone_WindowRearLeftArmour", 0.357, 0.181, -0.236, 1},
            {"Bone_WindowRearLeftArmour",  "CarNormal_Bone_WindowRearLeftArmour", 0.357, 0.181, -0.236, 1},
            {"Scrap_WindowRearLeftArmour", "CarNormal_Bone_WindowRearLeftArmour", 0.357, 0.181, -0.236, 1},
            {"Light_WindowRearLeftArmour", "CarNormal_Bone_WindowRearLeftArmour", 0.357, 0.181, -0.236, 1},
            {"Heavy_WindowRearLeftArmour", "CarNormal_Bone_WindowRearLeftArmour", 0.357, 0.181, -0.236, 1},
        },

        ["Armour_WindowRearRight"] =
        {
            {"Wood_WindowRearRightArmour",  "CarNormal_Bone_WindowRearRightArmour", -0.357, 0.181, -0.236, 1},
            {"Bone_WindowRearRightArmour",  "CarNormal_Bone_WindowRearRightArmour", -0.357, 0.181, -0.236, 1},
            {"Scrap_WindowRearRightArmour", "CarNormal_Bone_WindowRearRightArmour", -0.357, 0.181, -0.236, 1},
            {"Light_WindowRearRightArmour", "CarNormal_Bone_WindowRearRightArmour", -0.357, 0.181, -0.236, 1},
            {"Heavy_WindowRearRightArmour", "CarNormal_Bone_WindowRearRightArmour", -0.357, 0.181, -0.236, 1},
        },

        ["Storage_RoofRack"] =
        {
            {"Wood_RoofRack",  "CarNormal_Bone_RoofRack", 0.0, 0.34, -0.132, 1},
            {"Bone_RoofRack",  "CarNormal_Bone_RoofRack", 0.0, 0.34, -0.132, 1},
            {"Scrap_RoofRack", "CarNormal_Bone_RoofRack", 0.0, 0.34, -0.132, 1},
            {"Light_RoofRack", "CarNormal_Bone_RoofRack", 0.0, 0.34, -0.132, 1},
            {"Heavy_RoofRack", "CarNormal_Bone_RoofRack", 0.0, 0.34, -0.132, 1},
        },
    },
}
